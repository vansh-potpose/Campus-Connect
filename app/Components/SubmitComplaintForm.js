...
export function SubmitComplaintForm({ onBack }) {
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="text-center mb-8">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Your feedback helps us improve campus life. Share your concerns and we'll work to address them.
        </p>
      </div>
        ...
        <div className="lg:col-span-2">
          <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6 transition-all">
            <div className="mb-6">
              ...
              <p className="text-gray-600">Provide clear and detailed information about your concern</p>
            </div>
            ...
            {success ? (
              <div className="flex items-center gap-3 p-4 rounded-lg mb-4 bg-green-50 text-green-700 border border-green-100">
                ...
                Your complaint has been submitted successfully! You'll be redirected to the home page shortly.
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="mb-4">
                  <label htmlFor="title" className="block mb-2 font-medium text-gray-700">Complaint Title *</label>
                  <input
                    id="title"
                    type="text"
                ...
                <div className="mb-4">
                  <label htmlFor="description" className="block mb-2 font-medium text-gray-700">Detailed Description *</label>
                  <textarea
                    id="description"
                ...
                <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg mb-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500">
                      Your identity will be kept private when submitting this complaint
                    </p>
                  </div>
                </div>
          ...
          <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6 transition-all">
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <p className="text-sm text-gray-600">Your complaint is reviewed by our team</p>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-sm font-medium">
                  2
                </div>
                <p className="text-sm text-gray-600">It's assigned to the appropriate staff member</p>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-sm font-medium">
                  3
                </div>
                <p className="text-sm text-gray-600">You'll receive updates on the progress</p>
              </div>
            </div>
          </div>
        </div>
