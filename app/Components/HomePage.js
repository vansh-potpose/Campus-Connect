...
export function HomePage({ onViewComplaint,onViewExperience }) {
  ...
  const sortedExperiences = [...interviewExperiences].sort((a, b) => 
    new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime()
  );
    ...
    <div className="max-w-7xl mx-auto py-8 px-4">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Your voice matters. Share complaints, discover interview experiences, and help build a better campus community.
        </p>
      </div>
      ...
      <div className="grid grid-cols-3 md:grid-cols-3 gap-6 mb-12">
        <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-2xl font-semibold text-gray-900 mb-1">{complaints.length}</p>
        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-2xl font-semibold text-gray-900 mb-1">{interviewExperiences.length}</p>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center justify-between w-full gap-4">
            ...
            <div className="flex items-center gap-3">
              <span className={`text-sm font-medium ${showComplaints ? 'text-blue-600' : 'text-gray-400'}`}>Complaints</span>
        ...
        {showComplaints ? (
          sortedComplaints.length > 0 ? (
            ...
            <div className="col-span-full text-center py-12">
              ...
              <p className="text-gray-500">No complaints yet. Be the first to share your concerns!</p>
            </div>
          )
        ) : (
          sortedExperiences.length > 0 ? (
            ...
            <div className="col-span-full text-center py-12">
              ...
              <p className="text-gray-500">No experiences shared yet. Help others by sharing your interview experience!</p>
            </div>
          )
        )}
      </div>
