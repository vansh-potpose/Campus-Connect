...
export default function ExperienceDetail({ interviewExperienceId, onBack }) {
  ...
  const experience = interviewExperiences.find(
    (e) => e.id === interviewExperienceId
  );
  const student = experience
    ? users.find((u) => u.id === experience.studentId)
    : null;
      ...
      <div className="max-w-7xl mx-auto py-8 px-4">
        <div className="bg-white rounded-xl shadow-md border border-gray-100 p-12 text-center">
          ...
          <p className="text-gray-600 mb-4">
            The interview experience you're looking for doesn't exist or has
            been removed.
          </p>
          <button
            onClick={onBack}
  ...
  const experienceQuestions = localQuestions.filter(
    (q) => q.interviewExperienceId === experience.id
  );
  ...
  const canAnswer = user && user.userId === experience.userId;

  // Anyone except the owner can ask a question
  const canAsk = user && user.userId !== experience.userId;
        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-700 leading-relaxed">
              <span className="font-semibold">Tips:</span> {experience.tips}
            </p>
          </div>
        ...
        <div className="p-6">
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Ask questions or answer queries about this interview experience
            </p>
          </div>
            ...
            {experienceQuestions.length > 0 ? (
              experienceQuestions
                ...
                .map((q) => {
                  ...
                  const answerer = answer
                    ? users.find((u) => u.id === answer.answered_by)
                    : null;
                  return (
                    <div
                      key={q.id}
                    ...
                    >
                      ...
                      {answer ? (
                          ...
                          >
                            ...
                            <div className="flex gap-2 mt-2">
                              <button
                                ...
                                disabled={
                                  submitting ||
                                  !(newAnswer[q.id] && newAnswer[q.id].trim())
                                }
                              >
                        ...
                        <div className="mt-3 pl-4 text-gray-400 italic text-sm">
                          Waiting for answer...
                        </div>
                      )}
                    </div>
