          ...
          <div className="flex items-start justify-between mb-4">
            <div className="flex-1">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                {complaint.anonymous && (
                  <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold gap-1 bg-transparent text-black border border-gray-300">
                    Anonymous
                  </span>
                )}
              </div>
        ...
        <div className="p-6">
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Communication between staff and administration regarding this
              complaint
            </p>
          </div>
            ...
            {feedbackArr.length > 0 ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-500">
                  No feedback yet. Staff members can add updates here.
                </p>
              </div>
            )}
          </div>
          ...
          <div className="border-t pt-6">
            ...
            <form onSubmit={handleSubmitFeedback} className="space-y-4">
              ...
              <button
                type="submit"
                className="inline-flex items-center justify-center px-4 py-2 rounded-md font-medium text-sm bg-[#171717] hover:bg-[#171717e6] text-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
